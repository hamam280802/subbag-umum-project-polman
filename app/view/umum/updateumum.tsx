...
export default function UpdateUmum(linkumum: ItemUmum) {
    const [modal, setModal] = useState(false)
    const [isMutating, setIsMutating] = useState(false);
    const [newTitle, setNewTitle] = useState(linkumum.title);
    ...
    async function handleUpdate(e: SyntheticEvent) {
        ...
        try {
            ...
            const res = await axios.put(`/api/pubs/${linkumum._id}`, data)
            if(res.status !== 200){
